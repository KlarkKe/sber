...
gdjs.EndScreenCode.asyncCallback18445484 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.EndScreenCode.asyncCallback18445484(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.EndScreenCode.userFunc0xa26ce0 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.EndScreenCode.userFunc0xa26ce0(runtimeScene);
